...
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_ProcessedMessages", x => new { x.MessageId, x.ConsumerName }));

        migrationBuilder.CreateIndex(name: "IX_AuditLogs_EventId", table: "AuditLogs", column: "EventId");
        migrationBuilder.CreateIndex(name: "IX_AuditLogs_PaymentId", table: "AuditLogs", column: "PaymentId");
        migrationBuilder.CreateIndex(name: "IX_OutboxMessages_Processed_CreatedAtUtc", table: "OutboxMessages", columns: ["Processed", "CreatedAtUtc"]);
        migrationBuilder.CreateIndex(name: "IX_Payments_CustomerId", table: "Payments", column: "CustomerId");
    }
